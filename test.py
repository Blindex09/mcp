...
def test_dependencies():
    ...
    if missing:
        print(f"\n  Instale com: uv sync  (ou pip install {' '.join(missing)})")
        return False
    return True
...
def test_browser_optional():
    ...
    try:
        ...
        print("  playwright ausente: as ferramentas de auditoria no navegador nao funcionarao (pip install playwright)")
